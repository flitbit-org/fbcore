...
namespace FlitBit.Core
{
		...
		where E : struct
	{
		...
		static Status() { Contract.Assert(typeof(E).IsEnum, Resources.Err_StatusTypeMustBeEnum); }

		/// <summary>
		///   Creates a new instance.
		/// </summary>
		/// <param name="initialState">Initial state</param>
		public Status(E initialState) { _status = Convert.ToInt32(initialState); }
		...
		/// </returns>
		public bool IsGreaterThan(E comparand) { return Thread.VolatileRead(ref _status) > Convert.ToInt32(comparand); }
		...
		/// </returns>
		public bool IsLessThan(E comparand) { return Thread.VolatileRead(ref _status) < Convert.ToInt32(comparand); }
		...
		public bool Equals(Status<E> other) { return this._status == other._status; }
		...
		/// <returns>true if equal; otherwise false</returns>
		public override bool Equals(object obj) { return (obj is Status<E>) && Equals((Status<E>) obj); }
		...
		public static bool operator ==(Status<E> lhs, Status<E> rhs) { return lhs.Equals(rhs); }
		...
		/// <param name="rhs">right hand comparand</param>
		/// <returns>true if the comparands are equal</returns>
		public static bool operator ==(Status<E> lhs, E rhs) { return lhs.Equals(ToStatus(rhs)); }
		...
		/// <param name="rhs">right hand comparand</param>
		/// <returns>true if the comparands are equal</returns>
		public static bool operator ==(E lhs, Status<E> rhs) { return ToStatus(lhs).Equals(rhs); }
		...
		public static E ToObject(Status<E> s) { return s.CurrentState; }
		...
		[SuppressMessage("Microsoft.Design", "CA1000", Justification = "By design.")]
		public static Status<E> ToStatus(E s) { return new Status<E>(s); }
	}
}
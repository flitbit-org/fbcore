...
namespace FlitBit.Core.Collections
{
	...
	{		
		...
		/// <returns>If there is a value in the dictionary already associated with the key
		/// then that value is returned; otherwise default(V).</returns>
		/// <remarks>
		...
		/// <returns><em>true</em> if the value is present and can be parsed; otherwise <em>false</em></returns>
